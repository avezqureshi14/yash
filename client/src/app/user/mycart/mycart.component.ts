...
export class MycartComponent implements OnInit {
  ...
  async getCartItems() {
    const cartdata: any = await this.rest.get(`https://yash-knbl.onrender.com/api/user/viewcart/${this.data.loginUserDetails._id}`)
  ...
  async deleteCart(id: any) {
    await this.rest.delete(`https://yash-knbl.onrender.com/api/user/cart-item-delete/${id}`)
    this.getCartItems()
  }
